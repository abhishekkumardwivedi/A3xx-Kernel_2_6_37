...
/*----------------------------------------------------------------------*/
//General Purpose bank register
// Register and bits for GPBR1 register
#define TWL4030_REG_GPBR1			0x0c
#define TWL4030_GPBR1_MADC_HFCLK_EN		(1 << 7) // select 1 MHz clock divider based on HF 26MHz clock
#define TWL4030_GPBR1_MADC_DFLT_CLK_EN	(1 << 4) // MADC is HFCLK/26
...
/*
 * Multichannel ADC values
 */

#define TWL4030_MADC_ON             (1 << 0)	/* MADC power on */
#define TWL4030_MADC_MADCON			TWL4030_MADC_ON
#define TWL4030_MADC_SELECT_CH_0    1
#define TWL4030_MADC_CTRL_SW_TOGGLE (1 << 5) // MADC SWx start conversion
#define TWL4030_MADC_SW_START		TWL4030_MADC_CTRL_SW_TOGGLE
...
#define TWL4030_BCI_BCICTL2         0x024
...
extern int twl4030_wd_enable(int sec);
...
struct twl4030_codec_audio_data {
	...
	unsigned int cradle_aud_gpio;  //cradle audio switch. exists in M307i only
