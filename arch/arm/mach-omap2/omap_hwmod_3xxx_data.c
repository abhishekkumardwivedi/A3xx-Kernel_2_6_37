...
static int omap3xxx_gpio_hwmod_reset(struct omap_hwmod *oh)
{
	int ret = ocp_softreset_without_reset(oh);
	printk("gpio ocp_softreset_without_reset\n");
	return ret;
}
...
static struct omap_hwmod_class omap3xxx_gpio_hwmod_class = {
	...
	.rev = 1,
#if defined (CONFIG_MACH_A300) || defined (CONFIG_MACH_A317)
	.reset = &omap3xxx_gpio_hwmod_reset,
#endif
};
...
static struct omap_hwmod_class omap3xxx_bandgap_hwmod_class = {
	.name	= "bandgap",
};


/* bandgap */
static struct omap_hwmod omap3xxx_bandgap_hwmod = {
	.name		   = "bandgap",
	.class		   = &omap3xxx_bandgap_hwmod_class,
	.omap_chip	   = OMAP_CHIP_INIT(CHIP_IS_OMAP3430),
};
