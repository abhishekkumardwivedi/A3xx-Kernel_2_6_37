 ...
 * warm reset: disable default sequence
 *
...
void omap3_clear_scratchpad_contents(void)
{
	...
	struct omap3_scratchpad scratch;

	printk("omap3_clear_scratchpad_contents:\n");
#endif
	v_addr = OMAP2_L4_IO_ADDRESS(OMAP343X_SCRATCHPAD_ROM);

#if defined (CONFIG_MACH_A300) || defined (CONFIG_MACH_A317)
	memset_io(v_addr, 0, sizeof(scratch));


	v_addr = OMAP2_L4_IO_ADDRESS(OMAP343X_SCRATCHPAD);
	memset_io(v_addr, 0, sizeof(scratch));
#else
