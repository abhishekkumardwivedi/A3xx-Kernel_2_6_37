...
void omap_prcm_arch_reset(char mode, const char *cmd)
{
	...
	// Enable PWRON pulses generation
#if defined (CONFIG_MACH_A300)
	gpio_set_value(186, 0);
#else
	gpio_set_value(186, 1);
#endif

	/* XXX should be moved to some OMAP2/3 specific code */
	omap2_prm_set_mod_reg_bits(OMAP_RST_GS_MASK | OMAP_RST_DPLL3_MASK, prcm_offs, OMAP2_RM_RSTCTRL);
#else
