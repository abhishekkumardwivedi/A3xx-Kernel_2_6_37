...
//	printk("twl4030_codec_set_resource: (enable=%d, resource id=%X)\n", enable, id);
...
//	printk("twl4030_codec_enable_resource: resource id=%X\n", id);
...
//	printk("twl4030_codec_disable_resource: resource id=%X\n", id);
