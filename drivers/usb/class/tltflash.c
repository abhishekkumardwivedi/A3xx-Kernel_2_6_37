...
static int tlt_tty_tiocmget(struct tty_struct *tty, struct file *file)
{
	return -EPERM;
}

static int tlt_tty_tiocmset(struct tty_struct *tty, struct file *file,
			   unsigned int set, unsigned int clear)
{
	return -EPERM;
}

static int tlt_tty_ioctl(struct tty_struct *tty, struct file *file,
