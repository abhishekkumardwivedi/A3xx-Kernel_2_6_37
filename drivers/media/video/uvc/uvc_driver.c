...
//unsigned int uvc_trace_param = UVC_TRACE_PROBE | UVC_TRACE_DESCR | UVC_TRACE_CONTROL | UVC_TRACE_FORMAT | UVC_TRACE_CAPTURE | UVC_TRACE_CALLS | UVC_TRACE_IOCTL | UVC_TRACE_FRAME;
//unsigned int uvc_trace_param = UVC_TRACE_PROBE | UVC_TRACE_DESCR | UVC_TRACE_CONTROL | UVC_TRACE_FORMAT | UVC_TRACE_CALLS | UVC_TRACE_IOCTL ;
