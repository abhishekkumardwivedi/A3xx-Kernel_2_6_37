...
static const struct fb_videomode modedb[] = {
    ...
    {
         /* 800x480 @ 71 Hz, 37.2 kHz*/
        NULL, 71, 800, 480, KHZ2PICOS(39272), 1, 254, 1, 43, 1, 1,
    	0, FB_VMODE_NONINTERLACED
    },
#if 1 //defined (CONFIG_MACH_A317)
    {
         /* 800x480 @ 80 Hz, 42.3 kHz*/
        NULL, 80, 800, 480, KHZ2PICOS(39272), 40, 40, 29, 13, 48, 3,
    	0, FB_VMODE_NONINTERLACED
    },
    {
         /* 800x480 @ 70 Hz, 37.2 kHz*/
        NULL, 70, 800, 480, KHZ2PICOS(39272), 46, 208, 23, 20, 2, 2,
    	0, FB_VMODE_NONINTERLACED
    },
#endif
